...
llmExpander = LLMExpander(model, tokenizer, max_new_tokens=100)
...
preprocessor.save_queries(
    test_queries_t1, "../../data/dataset/test_queries_t1_expanded_100.jsonl"
)

preprocessor.save_queries(
    test_queries_t2, "../../data/dataset/test_queries_t2_expanded_100.jsonl"
)
